...
/**
 * Factory for locally defined JAX-WS {@link Service} references.
 * Uses the JAX-WS {@link Service#create} factory API underneath.
 *
...
public class LocalJaxWsServiceFactory {
     ...
     *
     * @see Service#setHandlerResolver
     */
