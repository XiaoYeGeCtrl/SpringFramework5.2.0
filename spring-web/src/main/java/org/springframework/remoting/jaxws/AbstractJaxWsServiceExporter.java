 ...
 * (through the JAX-WS {@link WebService} annotation).
 *
...
public abstract class AbstractJaxWsServiceExporter implements BeanFactoryAware, InitializingBean, DisposableBean {
     ...
     *
     * @see Endpoint#setProperties
     * @see Endpoint#WSDL_SERVICE
     * @see Endpoint#WSDL_PORT
     */
    ...
    /**
     * Publish all {@link WebService} annotated beans in the
